...
| --- | --- |
| На телевизор, планшет или телефон ребёнка | **AndroidScreenTimer-1.5.0.apk** — сам ограничитель |
| На Android-телефон родителя, чтобы установить ограничитель на другое устройство | **AndroidScreenTimer-Parent-1.5.0.apk** — установщик со встроенным ограничителем |
